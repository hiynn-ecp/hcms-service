...
@ApiModel(value = "静态资源备份表")
@Data
public class SysStaticDataBackupsEntity implements Serializable {

    private static final long serialVersionUID = 1L;

    @ApiModelProperty(value = ",String")
    private String id;
    @ApiModelProperty(value = "静态文件数据源ID,String")
    private String sysStaticDataId;
    @ApiModelProperty(value = "备份静态资源名称,String")
    private String name;
    @ApiModelProperty(value = "备份静态资源路径,String")
    private String path;
    @ApiModelProperty(value = "备注,String")
    ...
    @ApiModelProperty(value = "恢复时间,Date")
    private Date recoverTime;
    @ApiModelProperty(value = "恢复人ID,String")
     ...
     */
    public SysStaticDataBackupsEntity insert(String userId) {
        update(userId);
     ...
     * @date 2019/11/11 14:27
     */
    public SysStaticDataBackupsEntity update(String userId) {
